...
playereffects.register_effect_type("peppoisoner", S("Poison"), "pep_poisoner.png", {"poisoner"},
	function(player)
...
pep.register_potion({
	basename = "poisoner",
	contentstring = S("Poison"),
	longdesc = S("Drinking it makes you damage quickly. Every second you get -10 HP, 10 times in total."),
	effect_type = "peppoisoner",
	duration = 10,
})
pep.register_potion({
	basename = "grav0",
...
if(minetest.get_modpath("default")~=nil) then
	...
	if(minetest.get_modpath("flowers") ~= nil) then
		...
		if(minetest.get_modpath("farming") ~= nil) then
			minetest.register_craft({
				type = "shapeless",
				output = "pep:regen",
				recipe = { "paleotest:leech_blood", "farming:flour", "flowers:mushroom_brown", "vessels:glass_bottle" }
			})
		end
	end
	if(minetest.get_modpath("farming") ~= nil) then
		...
		if minetest.get_modpath("mana") ~= nil then
			minetest.register_craft({
				...
				recipe = { "default:dry_shrub", "default:dry_shrub", "paleotest:ammonite_bile", "default:mese_crystal_fragment",
	...
	minetest.register_craft({
		...
		recipe = { "default:leaves", "paleotest:pelt", "default:iron_lump", "flowers:dandelion_yellow", "vessels:glass_bottle" }
	})
	minetest.register_craft({
		type = "shapeless",
		output = "pep:grav0",
		recipe = { "paleotest:ammonite_bile", "vessels:glass_bottle" }
	})
	minetest.register_craft({
		type = "shapeless",
		output = "pep:mole",
		recipe = { "default:pick_steel", "default:axe_steel", "vessels:glass_bottle" },
	})
	minetest.register_craft({
		type = "shapeless",
...
if(minetest.get_modpath("flowers") ~= nil) then
	minetest.register_craft({
		...
		recipe = { "default:pine_sapling", "paleotest:ammonite_bile", "flowers:dandelion_yellow", "default:junglegrass", "vessels:glass_bottle" }
	})
end
end
