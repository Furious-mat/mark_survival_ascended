...
minetest.register_node(tpad.nodename, {
	...
	description = "Tek Teleporter Pad",
...
minetest.register_craft({
	output = "tpad:tpad",
	recipe = {
		{"overpowered:ingot", "screwdriver:screwdriver", "overpowered:untreatedingot"},
		{"group:polymer", "overpowered:ingot", "group:polymer"},
		{"default:steelblock", "overpowered:alpha_dragon_lock", "default:steel_ingot"},
		{"paleotest:black_pearl", "quartz:quartz_crystal", "paleotest:black_pearl"},
		{"paleotest:electronics", "default:iron_lump", "paleotest:electronics"},
	}
})
