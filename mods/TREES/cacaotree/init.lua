...
local grow_time_min = 5
local grow_time_max = 10
...
minetest.register_craft({
	...
	recipe = {"cacaotree:cocoa_powder", "mt_granola:granola"},
	replacements = {{"mt_granola:granola", "bucket:bucket_empty"}},
})
...
minetest.register_craft({
	...
	recipe = {"cacaotree:cocoa_powder", "group:egg", "farming:wheat"},
})
...
minetest.register_craft({
	output = "cacaotree:trunk 2",
	recipe = {
		{"default:wood", "default:wood", "default:wood"},
		{"default:wood", "cacaotree:sapling", "default:wood"},
		{"default:wood", "default:wood", "default:wood"},
	}
})
