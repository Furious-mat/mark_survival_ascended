...
local function alpha_defense_unit_logic(self)
...
minetest.register_entity("msa_endgame:alpha_defense_unit",{
    -- Stats
    max_hp = 2772,
    ...
    timeout = 0,
    logic = alpha_defense_unit_logic,
    get_staticdata = mobkit.statfunc,
	on_activate = function(self, staticdata, dtime_s)
        mob_core.on_activate(self, staticdata, dtime_s)
        self.alpha_overseer_id = mobkit.recall(self, "alpha_overseer_id") or nil
    end,
...
mob_core.register_spawn_egg("msa_endgame:alpha_defense_unit", "bdbdbd", "797979")
