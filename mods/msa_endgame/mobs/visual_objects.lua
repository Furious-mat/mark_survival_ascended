...
local overseer_laser = {
    ...
    on_step = function(self, dtime)
        ...
        if vector.distance(pos, tpos) < 2 then
            ...
            and self.target:get_luaentity().name ~= "msa_endgame:dead_horse" then
                ...
                local horse = minetest.add_entity(tpos, "msa_endgame:dead_horse")
            ...
            if self.target:is_player() and self.target:get_hp() <= 0 then
                local gamma_overseer = minetest.add_entity(tpos, "msa_endgame:gamma_defense_unit")
...
minetest.register_entity("msa_endgame:overseer_laser", overseer_laser)
...
local beta_overseer_laser = {
    ...
    on_step = function(self, dtime)
        ...
        if vector.distance(pos, tpos) < 2 then
            ...
            minetest.sound_play("endgame_player_hurt", {gain = 1})
            if self.target:is_player() and self.target:get_hp() <= 0 then
                local beta_overseer = minetest.add_entity(tpos, "msa_endgame:beta_defense_unit")
...
minetest.register_entity("msa_endgame:beta_overseer_laser", beta_overseer_laser)
...
local alpha_overseer_laser = {
    ...
    on_step = function(self, dtime)
        ...
        if vector.distance(pos, tpos) < 2 then
            ...
            minetest.sound_play("endgame_player_hurt", {gain = 1})
            if self.target:is_player() and self.target:get_hp() <= 0 then
                local alpha_overseer = minetest.add_entity(tpos, "msa_endgame:alpha_defense_unit")
...
minetest.register_entity("msa_endgame:alpha_overseer_laser", alpha_overseer_laser)
