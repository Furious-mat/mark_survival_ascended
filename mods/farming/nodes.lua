...
for i = 1, 5 do
	minetest.override_item("default:grass_"..i, {drop = {
		...
		items = {
			...
			{items = {"crops:tomato_seed"}, rarity = 5},
			{items = {"crops:corn"}, rarity = 5},
			{items = {"crops:melon_seed"}, rarity = 5},
			{items = {"crops:green_bean_seed"}, rarity = 5},
			{items = {"crops:potato_eyes"}, rarity = 5},
			{items = {"crops:pumpkin_seed"}, rarity = 5},
			{items = {"dfarm:seed_carrot"}, rarity = 5},
			{items = {"dfarm:seed_potato"}, rarity = 5},
			{items = {"dfarm:seed_pumpkin"}, rarity = 5},
			{items = {"dfarm:seed_melon"}, rarity = 5},
			{items = {"dfarm:seed_strawberry"}, rarity = 5},
