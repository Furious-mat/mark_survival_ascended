...
minetest.register_craft({
	output = "swamp:root_with_mud",
	recipe = {
		{"swamp:mud", "swamp:root"},
	}
})

minetest.register_craft({
	output = "swamp:muddy_mud 100",
	recipe = {
		{"swamp:mud", "air"},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{"swamp:mangrove_door", "swamp:mangrove_wood",},
		{"swamp:mangrove_door", "swamp:mangrove_wood"},
	}
})

minetest.register_craft({
	output = "swamp:mangrove_wood 8",
	recipe = {
		{"default:wood", "default:wood", "default:wood"},
		{"default:wood", "swamp:mangrove_sapling", "default:wood"},
		{"default:wood", "default:wood", "default:wood"},
	}
})
