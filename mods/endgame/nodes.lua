...
minetest.register_node("endgame:space", {
	description = "Space",
...
minetest.register_node("endgame:ark", {
    description = "Ark",
    drawtype = "mesh",
...
minetest.register_node("endgame:tek_block", {
...
minetest.register_node("endgame:gamma_overseer_terminal", {
	...
	on_metadata_inventory_take = function(pos)
		...
		minetest.add_entity(pos, "endgame:gamma_overseer")
...
minetest.register_node("endgame:beta_overseer_terminal", {
	...
	on_metadata_inventory_take = function(pos)
		minetest.remove_node(pos)
		minetest.add_entity(pos, "endgame:beta_overseer")
		minetest.sound_play("overseer", {gain = 1})
		minetest.add_particlespawner(
			8,
			2,
...
minetest.register_node("endgame:alpha_overseer_terminal", {
	...
	on_metadata_inventory_take = function(pos)
		minetest.remove_node(pos)
		minetest.add_entity(pos, "endgame:alpha_overseer")
		minetest.sound_play("overseer", {gain = 1})
		minetest.add_particlespawner(
			8,
			2,
