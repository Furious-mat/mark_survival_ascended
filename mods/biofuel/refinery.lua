...
minetest.register_craft({
	...
	recipe = {
		{"default:steelblock", "paleotest:polymer", "paleotest:polymer", "default:steelblock"},
		{"paleotest:electronics", "group:polymer", "paleotest:electronics", "group:paste"},
		{"group:paste", "paleotest:electronics", "group:polymer", "paleotest:electronics"},
		{"paleotest:sparkpowder", "paleotest:keratin", "paleotest:keratin", "paleotest:sparkpowder"},
	}
})
