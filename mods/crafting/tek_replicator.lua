...
minetest.register_node("crafting:tek_replicator", {
	description = S("Tek Replicator"),
	drawtype = "normal",
	tiles = {"crafting.table_top.png", "machine_black.png",
		"overpowered_block.png", "overpowered_block.png",
		"overpowered_block.png", "overpowered_block.png"},
...
local tek_replicator_recipe = {
	output = "crafting:tek_replicator",
	recipe = {
			...
			{"paleotest:oil_ore","group:lock","paleotest:sparkpowder","paleotest:oil_ore"},
			{"paleotest:oil_ore","group:paste","group:paste","paleotest:oil_ore"},
			{"paleotest:oil_ore","quartz:quartz_crystal","quartz:quartz_crystal","paleotest:oil_ore"},
	},
}

minetest.register_craft(tek_replicator_recipe)
...
if minetest.get_modpath("hopper") and hopper ~= nil and hopper.add_container ~= nil then
	hopper:add_container({
		{"top", "crafting:tek_replicator", "store"},
		{"bottom", "crafting:tek_replicator", "store"},
		{"side", "crafting:tek_replicator", "store"},
	})
end
