...
minetest.register_entity("paleotest:tyrannosaurus", {
    ...
    drops = {
        ...
        {name = "paleotest:tyrannosaurus_arm", chance = 1, min = 1, max = 1}
    },
    timeout = 0,
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:tyrannosaurus_saddle" then
            mob_core.mount(self, clicker)
            minetest.sound_play("i3_skin_change", {gain = 1})
        end
