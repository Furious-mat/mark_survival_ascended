...
local tyrannosaurus_inv_size = 6 * 8
local inv_tyrannosaurus = {}
inv_tyrannosaurus.tyrannosaurus_number = tonumber(storage:get("tyrannosaurus_number") or 1)
...
local function deserialize_inventory(inv, data)
    local items = data
    for i = 0, tyrannosaurus_inv_size do
...
local function set_mob_tables(self)
    for _, entity in pairs(minetest.luaentities) do
        ...
        if name ~= self.name and
            ...
            name ~= "paleotest:alpha_tyrannosaurus" then
...
local function tyrannosaurus_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:tyrannosaurus_inv")
            end
        end
        
        minetest.remove_detached_inventory("tyrannosaurus_" .. self.tyrannosaurus_number)
...
minetest.register_entity("paleotest:tyrannosaurus", {
    ...
    female_textures = {"paleotest_tyrannosaurus_female.png", "paleotest_tyrannosaurus.png"},
    male_textures = {"paleotest_tyrannosaurus_male.png", "paleotest_tyrannosaurus.png"},
    ...
    drops = {
        ...
        {name = "paleotest:tyrannosaurus_arm", chance = 1, min = 2, max = 2}
    },
    timeout = 0,
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.tyrannosaurus_number = inv_tyrannosaurus.tyrannosaurus_number
    inv_tyrannosaurus.tyrannosaurus_number = inv_tyrannosaurus.tyrannosaurus_number + 1
    storage:set_int("tyrannosaurus_number", inv_tyrannosaurus.tyrannosaurus_number)
    local inv = minetest.create_detached_inventory("paleotest:tyrannosaurus_" .. self.tyrannosaurus_number, {})
    inv:set_size("main", tyrannosaurus_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        if paleotest.feed_tame(self, clicker, 125, true, true) then
            return
        end
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:tyrannosaurus_saddle" and clicker:get_player_name() == self.owner then
        ...
        minetest.show_formspec(clicker:get_player_name(), "paleotest:tyrannosaurus_inv",
            "size[8,9]" ..
            "list[detached:paleotest:tyrannosaurus_" .. self.tyrannosaurus_number .. ";main;0,0;8,6;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:tyrannosaurus_" .. self.tyrannosaurus_number .. ";main]" ..
...
minetest.register_craftitem("paleotest:tyrannosaurus_dossier", {
	description = "Tyrannosaurus Dossier",
	stack_max= 1,
	inventory_image = "paleotest_tyrannosaurus_fg_female.png",
	groups = {dossier = 1},
