...
local ichthyosaurus_inv_size = 1 * 8
local inv_ichthyosaurus = {}
inv_ichthyosaurus.ichthyosaurus_number = tonumber(storage:get("ichthyosaurus_number") or 1)
...
local function deserialize_inventory(inv, data)
    local items = data
    for i = 0, ichthyosaurus_inv_size do
...
local function ichthyosaurus_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:ichthyosaurus_inv")
            end
        end
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.ichthyosaurus_number = inv_ichthyosaurus.ichthyosaurus_number
    inv_ichthyosaurus.ichthyosaurus_number = inv_ichthyosaurus.ichthyosaurus_number + 1
    storage:set_int("ichthyosaurus_number", inv_ichthyosaurus.ichthyosaurus_number)
    local inv = minetest.create_detached_inventory("paleotest:ichthyosaurus_" .. self.ichthyosaurus_number, {})
    inv:set_size("main", ichthyosaurus_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:ichthyosaurus_saddle" and clicker:get_player_name() == self.owner then
            mob_core.mount(self, clicker)
        end
        if clicker:get_wielded_item():get_name() == "" and clicker:get_player_control().sneak == false and clicker:get_player_name() == self.owner then
        minetest.show_formspec(clicker:get_player_name(), "paleotest:ichthyosaurus_inv",
            "size[8,9]" ..
            "list[detached:paleotest:ichthyosaurus_" .. self.ichthyosaurus_number .. ";main;0,0;8,1;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:ichthyosaurus_" .. self.ichthyosaurus_number .. ";main]" ..
