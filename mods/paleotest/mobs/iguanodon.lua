...
local iguanodon_inv_size = 4 * 8
local inv_iguanodon = {}
inv_iguanodon.iguanodon_number = tonumber(storage:get("iguanodon_number") or 1)
...
local function iguanodon_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:iguanodon_inv")
            end
        end
        
        minetest.remove_detached_inventory("iguanodon_" .. self.iguanodon_number)
    ...
    if self.tamed then
		mob_core.random_loot_drop(self, 60, 300, "multiplant:seed_multiplant")
    end
...
minetest.register_entity("paleotest:iguanodon", {
    -- Stats
    max_hp = 250,
    ...
    springiness = 0,
    -- Visual
    collisionbox = {-1.2, 0, -1.2, 1.2, 1.4, 1.2},
    ...
    visual = "mesh",
    mesh = "paleotest_iguanodon.b3d",
    female_textures = {"paleotest_iguanodon_male.png"},
    male_textures = {"paleotest_iguanodon_female.png"},
    child_textures = {"paleotest_iguanodon_child.png"},
    animation = {
    ...
    sounds = {
        ...
        random = {
            name = "paleotest_iguanodon_idle",
            gain = 1.0,
            distance = 16
        },
        hurt = {
            name = "paleotest_iguanodon_hurt",
            gain = 1.0,
            distance = 16
        },
        death = {
            name = "paleotest_iguanodon_death",
            gain = 1.0,
            distance = 16
        }
    },
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.iguanodon_number = inv_iguanodon.iguanodon_number
    inv_iguanodon.iguanodon_number = inv_iguanodon.iguanodon_number + 1
    storage:set_int("iguanodon_number", inv_iguanodon.iguanodon_number)
    local inv = minetest.create_detached_inventory("paleotest:iguanodon_" .. self.iguanodon_number, {})
    inv:set_size("main", iguanodon_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:iguanodon_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_iguanodon_fg.png",
                male_image = "paleotest_iguanodon_fg.png",
                diet = "Herbivore",
                temper = "Reactive"
            }))
        end
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:iguanodon_saddle" and clicker:get_player_name() == self.owner then
            mob_core.mount(self, clicker)
        end
        if clicker:get_wielded_item():get_name() == "" and clicker:get_player_control().sneak == false and clicker:get_player_name() == self.owner then
        minetest.show_formspec(clicker:get_player_name(), "paleotest:iguanodon_inv",
            "size[8,9]" ..
            "list[detached:paleotest:iguanodon_" .. self.iguanodon_number .. ";main;0,0;8,4;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:iguanodon_" .. self.iguanodon_number .. ";main]" ..
...
mob_core.register_spawn_egg("paleotest:iguanodon", "473f33cc", "393225d9")

minetest.register_craftitem("paleotest:iguanodon_dossier", {
	description = "Iguanodon Dossier",
	stack_max= 1,
	inventory_image = "paleotest_iguanodon_fg.png",
	groups = {dossier = 1},
