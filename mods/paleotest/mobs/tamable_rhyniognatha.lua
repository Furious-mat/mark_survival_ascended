...
minetest.register_entity("paleotest:tamable_rhyniognatha", {
    -- Stats
    max_hp = 900,
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:rhyniognatha_saddle" then
            mob_core.mount(self, clicker)
        end
        if clicker:get_wielded_item():get_name() == "cryopod:cryopod" then
        cryopod.capture_with_cryopod(self, clicker)
        end
        if clicker:get_wielded_item():get_name() == "paleotest:sap" then
...
mob_core.register_spawn_egg("paleotest:tamable_rhyniognatha", "aca483cc", "231d14d9")
