...
minetest.register_entity("paleotest:alpha_megalodon", {
    -- Stats
    max_hp = 9600,
    ...
    textures = {
        "paleotest_alpha_megalodon.png", "paleotest_alpha_megalodon.png"
    },
    female_texture = {"paleotest_alpha_megalodon.png"},
    male_texture = {"paleotest_alpha_megalodon.png"},
    child_texture = {"paleotest_alpha_megalodon.png"},
    animation = {
    ...
    drops = {
        {name = "paleotest:alpha_megalodon_fin", chance = 1, min = 1, max = 1},
        {name = "paleotest:raw_prime_fish_meat", chance = 1, min = 40, max = 80},
    },
    timeout = 0,
...
mob_core.register_spawn_egg("paleotest:alpha_megalodon", "42635acc", "354e46d9")
