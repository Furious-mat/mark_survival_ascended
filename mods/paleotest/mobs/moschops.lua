...
local moschops_inv_size = 4 * 8
local inv_moschops = {}
inv_moschops.moschops_number = tonumber(storage:get("moschops_number") or 1)
...
local function give_xp_to_nearby_players(pos)
    ...
    for _, obj in ipairs(players) do
        if obj:is_player() then
            xp_redo.add_xp(obj:get_player_name(), 125)
        end
    end
end

local function moschops_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:moschops_inv")
            end
        end
        
        minetest.remove_detached_inventory("moschops_" .. self.moschops_number)
...
minetest.register_entity("paleotest:moschops", {
    -- Stats
    max_hp = 375,
    ...
    springiness = 0,
    -- Visual
    collisionbox = {-0.3, 0, -0.3, 0.3, 0.45, 0.3},
    ...
    visual = "mesh",
    mesh = "paleotest_moschops.b3d",
    textures = {
        "paleotest_moschops1.png", "paleotest_moschops3.png",
        "paleotest_moschops2.png", "paleotest_moschops4.png"
    },
    child_textures = {
        "paleotest_moschops1.png",
        "paleotest_moschops2.png",
        "paleotest_moschops3.png",
        "paleotest_moschops4.png"
    },
    animation = {
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.moschops_number = inv_moschops.moschops_number
    inv_moschops.moschops_number = inv_moschops.moschops_number + 1
    storage:set_int("moschops_number", inv_moschops.moschops_number)
    local inv = minetest.create_detached_inventory("paleotest:moschops_" .. self.moschops_number, {})
    inv:set_size("main", moschops_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:moschops_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_moschops_fg.png",
                male_image = "paleotest_moschops_fg.png",
                diet = "Omnivore",
                temper = "Cowardly"
            }))
        end
        if clicker:get_wielded_item():get_name() == "" and clicker:get_player_control().sneak == false and clicker:get_player_name() == self.owner then
        minetest.show_formspec(clicker:get_player_name(), "paleotest:moschops_inv",
            "size[8,9]" ..
            "list[detached:paleotest:moschops_" .. self.moschops_number .. ";main;0,0;8,4;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:moschops_" .. self.moschops_number .. ";main]" ..
...
mob_core.register_spawn_egg("paleotest:moschops", "6e512dcc", "2f1702d9")

minetest.register_craftitem("paleotest:moschops_dossier", {
	description = "Moschops Dossier",
	stack_max= 1,
	inventory_image = "paleotest_moschops_fg.png",
	groups = {dossier = 1},
