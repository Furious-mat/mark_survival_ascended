...
local megalosaurus_inv_size = 6 * 8
local inv_megalosaurus = {}
inv_megalosaurus.megalosaurus_number = tonumber(storage:get("megalosaurus_number") or 1)
...
local function deserialize_inventory(inv, data)
    local items = data
    for i = 0, megalosaurus_inv_size do
...
local function megalosaurus_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:megalosaurus_inv")
            end
        end
...
minetest.register_entity("paleotest:megalosaurus", {
    -- Stats
    max_hp = 1025,
    ...
    visual = "mesh",
    mesh = "paleotest_megalosaurus.b3d",
    female_textures = {"paleotest_megalosaurus_male.png"},
    male_textures = {"paleotest_megalosaurus_male.png"},
    child_textures = {"paleotest_megalosaurus_child.png"},
    sleep_overlay = "paleotest_megalosaurus_child.png",
    child_sleep_overlay = "paleotest_megalosaurus_child.png",
    animation = {
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.megalosaurus_number = inv_megalosaurus.megalosaurus_number
    inv_megalosaurus.megalosaurus_number = inv_megalosaurus.megalosaurus_number + 1
    storage:set_int("megalosaurus_number", inv_megalosaurus.megalosaurus_number)
    local inv = minetest.create_detached_inventory("paleotest:megalosaurus_" .. self.megalosaurus_number, {})
    inv:set_size("main", megalosaurus_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        if paleotest.feed_tame(self, clicker, 99, true, true) then
            return
        end
        paleotest.imprint_tame(self, clicker)
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:megalosaurus_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_megalosaurus_fg.png",
                male_image = "paleotest_megalosaurus_fg.png",
                diet = "Carnivore",
                temper = "Nocturnally Aggressive"
            }))
        end
        if clicker:get_wielded_item():get_name() == "paleotest:megalosaurus_saddle" and clicker:get_player_name() == self.owner then
        ...
        minetest.show_formspec(clicker:get_player_name(), "paleotest:megalosaurus_inv",
            "size[8,9]" ..
            "list[detached:paleotest:megalosaurus_" .. self.megalosaurus_number .. ";main;0,0;8,6;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:megalosaurus_" .. self.megalosaurus_number .. ";main]" ..
...
mob_core.register_spawn_egg("paleotest:megalosaurus", "60544dcc", "453e39d9")

minetest.register_craftitem("paleotest:megalosaurus_dossier", {
	description = "Megalosaurus Dossier",
	stack_max= 1,
	inventory_image = "paleotest_megalosaurus_fg.png",
	groups = {dossier = 1},
