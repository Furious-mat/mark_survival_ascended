...
local pulmonoscorpius_inv_size = 1 * 8
local inv_pulmonoscorpius = {}
inv_pulmonoscorpius.pulmonoscorpius_number = tonumber(storage:get("pulmonoscorpius_number") or 1)
...
local function deserialize_inventory(inv, data)
    local items = data
    for i = 0, pulmonoscorpius_inv_size do
...
local function pulmonoscorpius_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:pulmonoscorpius_inv")
            end
        end
        
        minetest.remove_detached_inventory("pulmonoscorpius_" .. self.pulmonoscorpius_number)
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.pulmonoscorpius_number = inv_pulmonoscorpius.pulmonoscorpius_number
    inv_pulmonoscorpius.pulmonoscorpius_number = inv_pulmonoscorpius.pulmonoscorpius_number + 1
    storage:set_int("pulmonoscorpius_number", inv_pulmonoscorpius.pulmonoscorpius_number)
    local inv = minetest.create_detached_inventory("paleotest:pulmonoscorpius_" .. self.pulmonoscorpius_number, {})
    inv:set_size("main", pulmonoscorpius_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:pulmonoscorpius_saddle" and clicker:get_player_name() == self.owner then
        ...
        minetest.show_formspec(clicker:get_player_name(), "paleotest:pulmonoscorpius_inv",
            "size[8,9]" ..
            "list[detached:paleotest:pulmonoscorpius_" .. self.pulmonoscorpius_number .. ";main;0,0;8,1;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:pulmonoscorpius_" .. self.pulmonoscorpius_number .. ";main]" ..
