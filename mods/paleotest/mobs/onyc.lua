...
local function give_xp_to_nearby_players(pos)
    ...
    for _, obj in ipairs(players) do
        if obj:is_player() then
            xp_redo.add_xp(obj:get_player_name(), 55)
        end
    end
end
...
minetest.register_entity("paleotest:onyc", {
    -- Stats
    max_hp = 250,
    ...
    male_textures = {"paleotest_onyc.png"},
    child_textures = {"paleotest_onyc.png"},
    sleep_overlay = "paleotest_onyc.png",
    animation = {
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:onyc_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_onyc_fg.png",
                male_image = "paleotest_onyc_fg.png",
                diet = "Omnivore",
                temper = "Aggressive"
            }))
        end
...
mob_core.register_spawn_egg("paleotest:onyc", "aca483cc", "231d14d9")

minetest.register_craftitem("paleotest:onyc_dossier", {
	description = "Onyc Dossier",
	stack_max= 1,
