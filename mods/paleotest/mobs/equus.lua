...
local equus_inv_size = 2 * 8
local inv_equus = {}
inv_equus.equus_number = tonumber(storage:get("equus_number") or 1)
...
local function equus_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:equus_inv")
            end
        end
        
        minetest.remove_detached_inventory("equus_" .. self.equus_number)
...
minetest.register_entity("paleotest:equus", {
    -- Stats
    max_hp = 240,
    ...
    visual = "mesh",
    mesh = "paleotest_equus.b3d",
    female_textures = {"paleotest_equus.png"},
    male_textures = {"paleotest_equus.png"},
    child_textures = {"paleotest_equus.png"},
    ...
    driver_attach_at = {x = 0, y = 0.400, z = -0},
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.equus_number = inv_equus.equus_number
    inv_equus.equus_number = inv_equus.equus_number + 1
    storage:set_int("equus_number", inv_equus.equus_number)
    local inv = minetest.create_detached_inventory("paleotest:equus_" .. self.equus_number, {})
    inv:set_size("main", equus_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        minetest.show_formspec(clicker:get_player_name(), "paleotest:equus_inv",
            "size[8,9]" ..
            "list[detached:paleotest:equus_" .. self.equus_number .. ";main;0,0;8,2;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:equus_" .. self.equus_number .. ";main]" ..
...
mob_core.register_spawn_egg("paleotest:equus", "6e512dcc", "2f1702d9")

minetest.register_craftitem("paleotest:equus_dossier", {
	description = "Equus Dossier",
	stack_max= 1,
	inventory_image = "paleotest_equus_fg.png",
	groups = {dossier = 1},
