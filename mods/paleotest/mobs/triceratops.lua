...
local triceratops_inv_size = 4 * 8
local inv_triceratops = {}
inv_triceratops.triceratops_number = tonumber(storage:get("triceratops_number") or 1)
...
local function deserialize_inventory(inv, data)
    local items = data
    for i = 0, triceratops_inv_size do
...
local function triceratops_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:triceratops_inv")
            end
        end
        
        minetest.remove_detached_inventory("triceratops_" .. self.triceratops_number)
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.triceratops_number = inv_triceratops.triceratops_number
    inv_triceratops.triceratops_number = inv_triceratops.triceratops_number + 1
    storage:set_int("triceratops_number", inv_triceratops.triceratops_number)
    local inv = minetest.create_detached_inventory("paleotest:triceratops_" .. self.triceratops_number, {})
    inv:set_size("main", triceratops_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:triceratops_saddle" and clicker:get_player_name() == self.owner then
        ...
        minetest.show_formspec(clicker:get_player_name(), "paleotest:triceratops_inv",
            "size[8,9]" ..
            "list[detached:paleotest:triceratops_" .. self.triceratops_number .. ";main;0,0;8,4;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:triceratops_" .. self.triceratops_number .. ";main]" ..
...
minetest.register_craftitem("paleotest:triceratops_dossier", {
	description = "Triceratops Dossier",
	stack_max= 1,
	inventory_image = "paleotest_triceratops_fg_male.png",
	groups = {dossier = 1},
