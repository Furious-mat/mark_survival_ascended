...
local hyaenodon_inv_size = 2 * 8
local inv_hyaenodon = {}
inv_hyaenodon.hyaenodon_number = tonumber(storage:get("hyaenodon_number") or 1)
...
local function hyaenodon_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:hyaenodon_inv")
            end
        end
        
        minetest.remove_detached_inventory("hyaenodon_" .. self.hyaenodon_number)
...
minetest.register_entity("paleotest:hyaenodon", {
    -- Stats
    max_hp = 175,
    ...
    visual = "mesh",
    mesh = "paleotest_hyaenodon.b3d",
    female_textures = {"paleotest_hyaenodon.png"},
    male_textures = {"paleotest_hyaenodon.png"},
    child_textures = {"paleotest_hyaenodon.png"},
    sleep_overlay = "paleotest_hyaenodon.png",
    animation = {
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.hyaenodon_number = inv_hyaenodon.hyaenodon_number
    inv_hyaenodon.hyaenodon_number = inv_hyaenodon.hyaenodon_number + 1
    storage:set_int("hyaenodon_number", inv_hyaenodon.hyaenodon_number)
    local inv = minetest.create_detached_inventory("paleotest:hyaenodon_" .. self.hyaenodon_number, {})
    inv:set_size("main", hyaenodon_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            ...
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:hyaenodon_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_hyaenodon_fg.png",
                male_image = "paleotest_hyaenodon_fg.png",
                diet = "Carnivore",
                temper = "Opportunistic"
            }))
        end
        if clicker:get_wielded_item():get_name() == "" and clicker:get_player_control().sneak == false and clicker:get_player_name() == self.owner then
        minetest.show_formspec(clicker:get_player_name(), "paleotest:hyaenodon_inv",
            "size[8,9]" ..
            "list[detached:paleotest:hyaenodon_" .. self.hyaenodon_number .. ";main;0,0;8,2;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:hyaenodon_" .. self.hyaenodon_number .. ";main]" ..
...
mob_core.register_spawn_egg("paleotest:hyaenodon", "a2956fcc", "947e43d9")

minetest.register_craftitem("paleotest:hyaenodon_dossier", {
	description = "Hyaenodon Dossier",
	stack_max= 1,
	inventory_image = "paleotest_hyaenodon_fg.png",
	groups = {dossier = 1},
