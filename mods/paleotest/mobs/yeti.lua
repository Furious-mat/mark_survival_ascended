...
local function set_mob_tables(self)
    for _, entity in pairs(minetest.luaentities) do
        ...
        if name ~= self.name and
            ...
            name ~= "paleotest:polar_bear" then
...
local function yeti_logic(self)
...
minetest.register_entity("paleotest:yeti", {
    -- Stats
    max_hp = 2000,
    ...
    visual = "mesh",
    mesh = "paleotest_yeti.b3d",
    female_textures = {"paleotest_yeti_female.png"},
    male_textures = {"paleotest_yeti_male.png"},
    child_textures = {"paleotest_yeti_child.png"},
    animation = {
    ...
    sounds = {
        ...
        hurt = {
            name = "paleotest_yeti2",
            gain = 1.0,
            distance = 16
        },
        death = {
            name = "paleotest_yeti3",
            gain = 1.0,
            distance = 16
        }
    },
    ...
    on_rightclick = function(self, clicker)
        if paleotest.feed_tame(self, clicker, 65, false, false) then
            return
        end
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:yeti_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_yeti_fg.png",
                male_image = "paleotest_yeti_fg.png",
                diet = "Herbivore",
                temper = "Aggressive"
            }))
        end
...
mob_core.register_spawn_egg("paleotest:yeti", "60544dcc", "453e39d9")
