...
local mesopithecus_inv_size = 1 * 8
local inv_mesopithecus = {}
inv_mesopithecus.mesopithecus_number = tonumber(storage:get("mesopithecus_number") or 1)
...
local function deserialize_inventory(inv, data)
    local items = data
    for i = 0, mesopithecus_inv_size do
...
local function mesopithecus_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:mesopithecus_inv")
            end
        end
        
        minetest.remove_detached_inventory("mesopithecus_" .. self.mesopithecus_number)
    ...
    if mobkit.timer(self, 1) then
		...
		mob_core.random_drop(self, 900, 1800, "pooper:poop_turd")
...
minetest.register_entity("paleotest:mesopithecus", {
    -- Stats
    max_hp = 115,
    ...
    visual = "mesh",
    mesh = "paleotest_mesopithecus.b3d",
    female_textures = {"paleotest_mesopithecus4.png"},
    male_textures = {"paleotest_mesopithecus5.png"},
    child_textures = {"paleotest_mesopithecus1.png"},
    animation = {
    ...
    sounds = {
        ...
        random = {
            name = "paleotest_mesopithecus_idle",
            gain = 1.0,
            distance = 16
        },
        hurt = {
            name = "paleotest_mesopithecus_hurt",
            gain = 1.0,
            distance = 16
        },
        death = {
            name = "paleotest_mesopithecus_death",
            gain = 1.0,
            distance = 16
        }
    },
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.mesopithecus_number = inv_mesopithecus.mesopithecus_number
    inv_mesopithecus.mesopithecus_number = inv_mesopithecus.mesopithecus_number + 1
    storage:set_int("mesopithecus_number", inv_mesopithecus.mesopithecus_number)
    local inv = minetest.create_detached_inventory("paleotest:mesopithecus_" .. self.mesopithecus_number, {})
    inv:set_size("main", mesopithecus_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            ...
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:mesopithecus_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_mesopithecus_fg.png",
                male_image = "paleotest_mesopithecus_fg.png",
                diet = "Omnivore",
                temper = "Curious"
            }))
        end
        if clicker:get_wielded_item():get_name() == "" and clicker:get_player_control().sneak == false and clicker:get_player_name() == self.owner then
        minetest.show_formspec(clicker:get_player_name(), "paleotest:mesopithecus_inv",
            "size[8,9]" ..
            "list[detached:paleotest:mesopithecus_" .. self.mesopithecus_number .. ";main;0,0;8,1;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:mesopithecus_" .. self.mesopithecus_number .. ";main]" ..
...
mob_core.register_spawn_egg("paleotest:mesopithecus", "6e512dcc", "2f1702d9")

minetest.register_craftitem("paleotest:mesopithecus_dossier", {
	description = "Mesopithecus Dossier",
	stack_max= 1,
	inventory_image = "paleotest_mesopithecus_fg.png",
	groups = {dossier = 1},
