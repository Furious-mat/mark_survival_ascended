...
local brontosaurus_inv_size = 20 * 8
local inv_brontosaurus = {}
inv_brontosaurus.brontosaurus_number = tonumber(storage:get("brontosaurus_number") or 1)
...
local function deserialize_inventory(inv, data)
    local items = data
    for i = 0, brontosaurus_inv_size do
...
local function give_xp_to_nearby_players(pos)
    ...
    for _, obj in ipairs(players) do
        if obj:is_player() then
            xp_redo.add_xp(obj:get_player_name(), 240)
        end
    end
end

local function brontosaurus_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:brontosaurus_inv")
            end
        end
        
        minetest.remove_detached_inventory("brontosaurus_" .. self.brontosaurus_number)
...
minetest.register_entity("paleotest:brontosaurus", {
    -- Stats
    max_hp = 2070,
    ...
    springiness = 0,
    -- Visual
    collisionbox = {-2.4, -0.3, -2.4, 2.4, 1.3, 2.4},
    ...
    visual = "mesh",
    mesh = "paleotest_brontosaurus.b3d",
    female_textures = {"paleotest_brontosaurus.png"},
    male_textures = {"paleotest_brontosaurus.png"},
    child_textures = {"paleotest_brontosaurus_child.png"},
    animation = {
    ...
    sounds = {
        ...
        random = {
            name = "paleotest_brontosaurus_idle",
            gain = 1.0,
            distance = 32
        },
        hurt = {
        ...
        death = {
            name = "paleotest_brontosaurus_death",
            gain = 1.0,
            distance = 32
        }
    },
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.brontosaurus_number = inv_brontosaurus.brontosaurus_number
    inv_brontosaurus.brontosaurus_number = inv_brontosaurus.brontosaurus_number + 1
    storage:set_int("brontosaurus_number", inv_brontosaurus.brontosaurus_number)
    local inv = minetest.create_detached_inventory("paleotest:brontosaurus_" .. self.brontosaurus_number, {})
    inv:set_size("main", brontosaurus_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:brontosaurus_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_brontosaurus_fg.png",
                male_image = "paleotest_brontosaurus_fg.png",
                diet = "Herbivore",
                temper = "Docile"
            }))
        end
        if clicker:get_wielded_item():get_name() == "paleotest:brontosaurus_saddle" and clicker:get_player_name() == self.owner then
        ...
        minetest.show_formspec(clicker:get_player_name(), "paleotest:brontosaurus_inv",
            "size[30,30]" ..
            "list[detached:paleotest:brontosaurus_" .. self.brontosaurus_number .. ";main;0,0;8,20;]" ..
            "list[current_player;main;0,20;9,4;]" ..
            "listring[detached:paleotest:brontosaurus_" .. self.brontosaurus_number .. ";main]" ..
...
mob_core.register_spawn_egg("paleotest:brontosaurus", "473f33cc", "393225d9")

minetest.register_craftitem("paleotest:brontosaurus_dossier", {
	description = "Brontosaurus Dossier",
	stack_max= 1,
	inventory_image = "paleotest_brontosaurus_fg.png",
	groups = {dossier = 1},
