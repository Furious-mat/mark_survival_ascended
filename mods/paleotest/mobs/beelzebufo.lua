...
minetest.register_entity("paleotest:beelzebufo", {
    ...
    defend_owner = true,
    rivals = {},
    predators = {"paleotest:titanomyrma","paleotest:titanomyrma_soldier","paleotest:meganeura","paleotest:leech","paleotest:leech_diseased"},
    targets = {},
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:beelzebufo_saddle" then
