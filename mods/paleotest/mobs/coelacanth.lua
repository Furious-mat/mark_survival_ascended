...
minetest.register_entity("paleotest:coelacanth", {
    -- Stats
    max_hp = 30,
    ...
    scale_stage3 = 0.75,
    visual = "mesh",
    mesh = "paleotest_coelacanth.b3d",
    female_textures = {"paleotest_coelacanth.png"},
    male_textures = {"paleotest_coelacanth.png"},
    child_textures = {"paleotest_coelacanth.png"},
    animation = {
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:coelacanth_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_coelacanth_fg.png",
                male_image = "paleotest_coelacanth_fg.png",
                diet = "Unknown",
                temper = "Reactive"
            }))
        end
...
mob_core.register_spawn_egg("paleotest:coelacanth", "533b29cc", "4d3627d9")

minetest.register_craftitem("paleotest:coelacanth_dossier", {
	description = "Coelacanth Dossier",
	stack_max= 1,
	inventory_image = "paleotest_coelacanth_fg.png",
	groups = {dossier = 1},
