...
minetest.register_entity("paleotest:leedsichthys", {
    -- Stats
    max_hp = 4400,
    ...
    female_textures = {"paleotest_leedsichthys.png"},
    male_textures = {"paleotest_leedsichthys.png"},
    child_textures = {"paleotest_leedsichthys.png"},
    animation = {
    ...
    drops = {
        {name = "paleotest:fish_meat_raw", chance = 1, min = 100, max = 300},
        {name = "paleotest:raw_prime_fish_meat", chance = 1, min = 150, max = 250},
        {name = "paleotest:hide", chance = 1, min = 100, max = 500}
    },
    timeout = 0,
    ...
    on_rightclick = function(self, clicker)
		...
		mob_core.random_loot_drop(self, 1, 1, "paleotest:raw_prime_fish_meat")
        end
...
mob_core.register_spawn_egg("paleotest:leedsichthys", "533b29cc", "4d3627d9")

minetest.register_craftitem("paleotest:leedsichthys_dossier", {
	description = "Leedsichthys Dossier",
	stack_max= 1,
