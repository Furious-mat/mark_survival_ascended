...
local oviraptor_inv_size = 1 * 8
local inv_oviraptor = {}
inv_oviraptor.oviraptor_number = tonumber(storage:get("oviraptor_number") or 1)
...
local function oviraptor_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:oviraptor_inv")
            end
        end
        
        minetest.remove_detached_inventory("oviraptor_" .. self.oviraptor_number)
        ...
        if self.status ~= "sleeping" then
            ...
            if prty < 4 then
                if math.random(1, self.hunger) == 1 then
                    paleotest.hq_graze(self, 4, paleotest.global_egg)
                    return
                end
            end
        end
...
minetest.register_entity("paleotest:oviraptor", {
    -- Stats
    max_hp = 140,
    ...
    visual = "mesh",
    mesh = "paleotest_oviraptor.b3d",
    female_textures = {"paleotest_oviraptor.png"},
    male_textures = {"paleotest_oviraptor.png"},
    child_textures = {"paleotest_oviraptor.png"},
    sleep_overlay = "paleotest_oviraptor.png",
    animation = {
    ...
    sounds = {
        ...
        random = {
            name = "paleotest_oviraptor1",
            gain = 1.0,
            distance = 16
        },
        hurt = {
            name = "paleotest_oviraptor2",
            gain = 1.0,
            distance = 16
        },
        death = {
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.oviraptor_number = inv_oviraptor.oviraptor_number
    inv_oviraptor.oviraptor_number = inv_oviraptor.oviraptor_number + 1
    storage:set_int("oviraptor_number", inv_oviraptor.oviraptor_number)
    local inv = minetest.create_detached_inventory("paleotest:oviraptor_" .. self.oviraptor_number, {})
    inv:set_size("main", oviraptor_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:oviraptor_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_oviraptor_fg.png",
                male_image = "paleotest_oviraptor_fg.png",
                diet = "Carnivore",
                temper = "Skittish"
            }))
        end
        ...
        minetest.show_formspec(clicker:get_player_name(), "paleotest:oviraptor_inv",
            "size[8,9]" ..
            "list[detached:paleotest:oviraptor_" .. self.oviraptor_number .. ";main;0,0;8,1;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:oviraptor_" .. self.oviraptor_number .. ";main]" ..
...
mob_core.register_spawn_egg("paleotest:oviraptor", "6e512dcc", "2f1702d9")

minetest.register_craftitem("paleotest:oviraptor_dossier", {
	description = "Oviraptor Dossier",
	stack_max= 1,
	inventory_image = "paleotest_oviraptor_fg.png",
	groups = {dossier = 1},
