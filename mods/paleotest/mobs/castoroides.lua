...
local castoroides_inv_size = 6 * 8
local inv_castoroides = {}
inv_castoroides.castoroides_number = tonumber(storage:get("castoroides_number") or 1)
...
local function deserialize_inventory(inv, data)
    local items = data
    for i = 0, castoroides_inv_size do
...
local function castoroides_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:castoroides_inv")
            end
        end
        
        minetest.remove_detached_inventory("castoroides_" .. self.castoroides_number)
    ...
    if self.tamed then
		mob_core.random_loot_drop(self, 60, 300, "default:tree")
    end
...
minetest.register_entity("paleotest:castoroides", {
    -- Stats
    max_hp = 450,
    ...
    visual = "mesh",
    mesh = "paleotest_castoroides.b3d",
    female_textures = {"paleotest_castoroides.png"},
    male_textures = {"paleotest_castoroides.png"},
    child_textures = {"paleotest_castoroides.png"},
    sleep_overlay = "paleotest_castoroides.png",
    child_sleep_overlay = "paleotest_castoroides.png",
    animation = {
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.castoroides_number = inv_castoroides.castoroides_number
    inv_castoroides.castoroides_number = inv_castoroides.castoroides_number + 1
    storage:set_int("castoroides_number", inv_castoroides.castoroides_number)
    local inv = minetest.create_detached_inventory("paleotest:castoroides_" .. self.castoroides_number, {})
    inv:set_size("main", castoroides_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            ...
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:castoroides_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_castoroides_fg.png",
                male_image = "paleotest_castoroides_fg.png",
                diet = "Herbivore",
                temper = "Friendly"
            }))
        end
        if clicker:get_wielded_item():get_name() == "paleotest:beaver_saddle" and clicker:get_player_name() == self.owner then
        ...
        minetest.show_formspec(clicker:get_player_name(), "paleotest:castoroides_inv",
            "size[10,10]" ..
            "list[detached:paleotest:castoroides_" .. self.castoroides_number .. ";main;0,0;8,6;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:castoroides_" .. self.castoroides_number .. ";main]" ..
...
mob_core.register_spawn_egg("paleotest:castoroides", "473f33cc", "393225d9")

-- Beaver Dam --

minetest.register_node("paleotest:beaver_dam", {
	...
	on_construct = function(pos, itemstack)
			...
			local items = {'default:wood_stick 100', 'paleotest:silica_pearls', 'paleotest:cementing_paste'}
	...
	on_metadata_inventory_take = function(pos)
		...
		minetest.add_entity(pos, "paleotest:castoroides")
	end,
})

minetest.register_craftitem("paleotest:castoroides_dossier", {
	description = "Castoroides Dossier",
	stack_max= 1,
	inventory_image = "paleotest_castoroides_fg.png",
	groups = {dossier = 1},
