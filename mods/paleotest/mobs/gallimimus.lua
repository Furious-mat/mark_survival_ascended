...
local gallimimus_inv_size = 2 * 8
local inv_gallimimus = {}
inv_gallimimus.gallimimus_number = tonumber(storage:get("gallimimus_number") or 1)
...
local function deserialize_inventory(inv, data)
    local items = data
    for i = 0, gallimimus_inv_size do
...
local function gallimimus_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:gallimimus_inv")
            end
        end
        
        minetest.remove_detached_inventory("gallimimus_" .. self.gallimimus_number)
...
minetest.register_entity("paleotest:gallimimus", {
    -- Stats
    max_hp = 150,
    ...
    visual = "mesh",
    mesh = "paleotest_gallimimus.b3d",
    female_textures = {"paleotest_gallimimus_female.png"},
    male_textures = {"paleotest_gallimimus_male.png"},
    child_textures = {"paleotest_gallimimus_child.png"},
    sleep_overlay = "paleotest_gallimimus.png",
    animation = {
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.gallimimus_number = inv_gallimimus.gallimimus_number
    inv_gallimimus.gallimimus_number = inv_gallimimus.gallimimus_number + 1
    storage:set_int("gallimimus_number", inv_gallimimus.gallimimus_number)
    local inv = minetest.create_detached_inventory("paleotest:gallimimus_" .. self.gallimimus_number, {})
    inv:set_size("main", gallimimus_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:gallimimus_saddle" and clicker:get_player_name() == self.owner then
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:gallmimus_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_gallmimus_fg.png",
                male_image = "paleotest_gallmimus_fg.png",
                diet = "Herbivore",
                temper = "Skittish"
            }))
        end
        if clicker:get_wielded_item():get_name() == "" and clicker:get_player_control().sneak == false and clicker:get_player_name() == self.owner then
        minetest.show_formspec(clicker:get_player_name(), "paleotest:gallimimus_inv",
            "size[8,9]" ..
            "list[detached:paleotest:gallimimus_" .. self.gallimimus_number .. ";main;0,0;8,2;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:gallimimus_" .. self.gallimimus_number .. ";main]" ..
...
mob_core.register_spawn_egg("paleotest:gallimimus", "6e512dcc", "2f1702d9")

minetest.register_craftitem("paleotest:gallimimus_dossier", {
	description = "Gallimimus Dossier",
	stack_max= 1,
	inventory_image = "paleotest_gallmimus_fg.png",
	groups = {dossier = 1},
