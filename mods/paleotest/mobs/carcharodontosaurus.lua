...
minetest.register_entity("paleotest:carcharodontosaurus", {
    -- Stats
    max_hp = 70000,
    ...
    driver_attach_at = {x = 0, y = 5, z = 0},
    driver_eye_offset = {{x = 0, y = 80, z = 5}, {x = 0, y = 600, z = 55}},
    max_speed_forward = 6,
    max_speed_reverse = 3,
    -- Sound
    sounds = {
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:carcharodontosaurus_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_carcharodontosaurus_fg.png",
                male_image = "paleotest_carcharodontosaurus_fg.png",
                diet = "Carnivore",
                temper = "Aggressive"
            }))
        end
...
mob_core.register_spawn_egg("paleotest:carcharodontosaurus", "60544dcc", "453e39d9")

minetest.register_craftitem("paleotest:carcharodontosaurus_dossier", {
	description = "Carcharodontosaurus Dossier",
	stack_max= 1,
