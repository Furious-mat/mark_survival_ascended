...
local dire_bear_inv_size = 3 * 8
local inv_dire_bear = {}
inv_dire_bear.dire_bear_number = tonumber(storage:get("dire_bear_number") or 1)
...
local function dire_bear_logic(self)
    ...
    if self.hp <= 0 then
        ...
        if self.owner then
            ...
            if player then
                minetest.close_formspec(player:get_player_name(), "paleotest:dire_bear_inv")
            end
        end
        
        minetest.remove_detached_inventory("dire_bear_" .. self.dire_bear_number)
...
minetest.register_entity("paleotest:dire_bear", {
    -- Stats
    max_hp = 400,
    ...
    female_textures = {"paleotest_dire_bear.png"},
    male_textures = {"paleotest_dire_bear.png"},
    child_textures = {"paleotest_dire_bear.png"},
    sleep_overlay = "paleotest_dire_bear.png",
    child_sleep_overlay = "paleotest_dire_bear.png",
    animation = {
...
on_activate = function(self, staticdata, dtime_s)
    ...
    self.dire_bear_number = inv_dire_bear.dire_bear_number
    inv_dire_bear.dire_bear_number = inv_dire_bear.dire_bear_number + 1
    storage:set_int("dire_bear_number", inv_dire_bear.dire_bear_number)
    local inv = minetest.create_detached_inventory("paleotest:dire_bear_" .. self.dire_bear_number, {})
    inv:set_size("main", dire_bear_inv_size)
    self.inv = inv
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:dire_bear_saddle" and clicker:get_player_name() == self.owner then
        ...
        minetest.show_formspec(clicker:get_player_name(), "paleotest:dire_bear_inv",
            "size[8,9]" ..
            "list[detached:paleotest:dire_bear_" .. self.dire_bear_number .. ";main;0,0;8,3;]" ..
            "list[current_player;main;0,6;8,3;]" ..
            "listring[detached:paleotest:dire_bear_" .. self.dire_bear_number .. ";main]" ..
...
mob_core.register_spawn_egg("paleotest:dire_bear", "a0998fcc", "3b3630d9")

minetest.register_craftitem("paleotest:dire_bear_dossier", {
	description = "Dire Bear Dossier",
	stack_max= 1,
	inventory_image = "paleotest_dire_bear_fg.png",
	groups = {dossier = 1},
