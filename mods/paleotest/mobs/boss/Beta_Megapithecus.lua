...
local function megapithecus_logic(self)
    ...
    if self.hp <= 0 then
        ...
        minetest.chat_send_all("Beta Megapithecus has been defeated !")
        return
    end
...
minetest.register_entity("paleotest:beta_megapithecus", {
    -- Stats
    max_hp = 396000,
    ...
    drops = {
        {name = "overpowered:ingot", chance = 1, min = 110, max = 110},
        {name = "paleotest:beta_megapithecus_trophy", chance = 1, min = 1, max = 1},
        {name = "artifact:Megapithecus_Dossier_Item", chance = 1, min = 1, max = 1},
        {name = "artifact:beta_m", chance = 1, min = 1, max = 1},
        {name = "overpowered:beta_megapithecus_lock", chance = 1, min = 10, max = 10}
    },
    timeout = 0,
...
mob_core.register_spawn_egg("paleotest:beta_megapithecus", "a0998fcc", "3b3630d9")

-- Megapithecus TROPHY

minetest.register_node("paleotest:beta_megapithecus_trophy", {
	description = "Beta Megapithecus Trophy",
	drawtype = "mesh",
	mesh = "paleotest_megapithecus_trophy.obj",
	tiles = {"paleotest_beta_megapithecus.png"} ,
