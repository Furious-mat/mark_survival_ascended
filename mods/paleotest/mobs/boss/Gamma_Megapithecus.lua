...
local function megapithecus_logic(self)
    ...
    if self.hp <= 0 then
        ...
        minetest.chat_send_all("Gamma Megapithecus has been defeated !")
        return
    end
...
minetest.register_entity("paleotest:gamma_megapithecus", {
    -- Stats
    max_hp = 180000,
    ...
    female_textures = {"paleotest_megapithecus.png"},
    male_textures = {"paleotest_megapithecus.png"},
    child_textures = {"paleotest_megapithecus.png"},
    animation = {
    ...
    drops = {
        {name = "overpowered:ingot", chance = 1, min = 40, max = 40},
        {name = "paleotest:gamma_megapithecus_trophy", chance = 1, min = 1, max = 1},
        {name = "artifact:Megapithecus_Dossier_Item", chance = 1, min = 1, max = 1},
        {name = "artifact:gamma_m", chance = 1, min = 1, max = 1},
        {name = "overpowered:gamma_megapithecus_lock", chance = 1, min = 10, max = 10}
    },
    timeout = 0,
...
mob_core.register_spawn_egg("paleotest:gamma_megapithecus", "a0998fcc", "3b3630d9")

-- Megapithecus TROPHY

minetest.register_node("paleotest:gamma_megapithecus_trophy", {
	description = "Gamma Megapithecus Trophy",
	drawtype = "mesh",
	mesh = "paleotest_megapithecus_trophy.obj",
	tiles = {"paleotest_megapithecus_trophy.png"} ,
