...
local function dragon_logic(self)
    ...
    if self.hp <= 0 then
        ...
        minetest.chat_send_all("Alpha Dragon has been defeated !")
        return
    end
...
minetest.register_entity("paleotest:alpha_dragon", {
    -- Stats
    max_hp = 972000,
    ...
    drops = {
        ...
        {name = "paleotest:alpha_dragon_trophy", chance = 1, min = 1, max = 1},
        {name = "artifact:Dragon_Dossier_Item", chance = 1, min = 1, max = 1},
        {name = "artifact:alpha_d", chance = 1, min = 1, max = 1},
        {name = "overpowered:alpha_dragon_lock", chance = 1, min = 10, max = 10}
    },
    timeout = 0,
    logic = dragon_logic,
...
mob_core.register_spawn_egg("paleotest:alpha_dragon", "aca483cc", "231d14d9")

-- Dragon TROPHY

minetest.register_node("paleotest:alpha_dragon_trophy", {
	description = "Alpha Dragon Trophy",
	drawtype = "mesh",
