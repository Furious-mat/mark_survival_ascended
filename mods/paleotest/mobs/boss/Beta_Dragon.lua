...
local function dragon_logic(self)
    ...
    if self.hp <= 0 then
        ...
        minetest.chat_send_all("Beta Dragon has been defeated !")
        return
    end
...
minetest.register_entity("paleotest:beta_dragon", {
    -- Stats
    max_hp = 864000,
    ...
    drops = {
        ...
        {name = "paleotest:beta_dragon_trophy", chance = 1, min = 1, max = 1},
        {name = "artifact:Dragon_Dossier_Item", chance = 1, min = 1, max = 1},
        {name = "artifact:beta_d", chance = 1, min = 1, max = 1},
        {name = "overpowered:beta_dragon_lock", chance = 1, min = 10, max = 10}
    },
    timeout = 0,
    logic = dragon_logic,
...
mob_core.register_spawn_egg("paleotest:beta_dragon", "aca483cc", "231d14d9")

-- Dragon TROPHY

minetest.register_node("paleotest:beta_dragon_trophy", {
	description = "Beta Dragon Trophy",
	drawtype = "mesh",
