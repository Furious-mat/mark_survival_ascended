...
minetest.register_node("default:cobble", {
	...
	is_ground_content = false,
	groups = {cracky = 3, dinos = 2, stone = 2},
	sounds = default.node_sound_stone_defaults(),
	drop = {
		max_items = 5,
		items = {
...
minetest.register_node("default:mossycobble", {
	...
	is_ground_content = false,
	groups = {cracky = 3, dinos = 2, stone = 1},
	sounds = default.node_sound_stone_defaults(),
	drop = {
		max_items = 5,
		items = {
...
minetest.register_node("default:dirt_with_grass", {
	...
	groups = {soil = 1, spreading_dirt_type = 1, unbreakable = 1, immortal = 1, immovable = 2},
	is_ground_content = false,
	on_blast = function() end,
	can_dig = function() return false end,
	on_destruct = function() end,
...
minetest.register_node("default:dirt_with_grass_footsteps", {
	...
	tiles = {"default_grass.png^default_footprint.png", "default_dirt.png",
		{name = "default_dirt.png^default_grass_side.png",
			tileable_vertical = false}},
	groups = {unbreakable = 1, immortal = 1, immovable = 2, soil = 1},
	is_ground_content = false,
	on_blast = function() end,
	can_dig = function() return false end,
	on_destruct = function() end,
...
minetest.register_node("default:dirt_with_dry_grass", {
	...
	tiles = {"default_dry_grass.png",
		...
		{name = "default_dirt.png^default_dry_grass_side.png",
			tileable_vertical = false}},
	groups = {unbreakable = 1, immortal = 1, immovable = 2, spreading_dirt_type = 1},
	is_ground_content = false,
	on_blast = function() end,
	can_dig = function() return false end,
	on_destruct = function() end,
...
minetest.register_node("default:dirt_with_snow", {
	...
	tiles = {"default_snow.png", "default_dirt.png",
		{name = "default_dirt.png^default_snow_side.png",
			tileable_vertical = false}},
	groups = {unbreakable = 1, immortal = 1, immovable = 2, soil = 1, spreading_dirt_type = 1, snowy = 1},
	is_ground_content = false,
	on_blast = function() end,
	can_dig = function() return false end,
	on_destruct = function() end,
...
minetest.register_node("default:dirt_with_rainforest_litter", {
	...
	groups = {unbreakable = 1, immortal = 1, immovable = 2, soil = 1, spreading_dirt_type = 1},
	is_ground_content = false,
	on_blast = function() end,
	can_dig = function() return false end,
	on_destruct = function() end,
...
minetest.register_node("default:dry_dirt_with_dry_grass", {
	...
	tiles = {"default_dry_grass.png", "default_dry_dirt.png",
		{name = "default_dry_dirt.png^default_dry_grass_side.png",
			tileable_vertical = false}},
	groups = {soil = 1, unbreakable = 1, immortal = 1, immovable = 2},
	is_ground_content = false,
	on_blast = function() end,
	can_dig = function() return false end,
	on_destruct = function() end,
...
minetest.register_node("default:sapling", {
	...
	on_construct = function(pos)
		minetest.get_node_timer(pos):start(math.random(10, 15))
	end,
...
minetest.register_node("default:leaves", {
	...
	paramtype = "light",
	is_ground_content = false,
	groups = {dig_immediate = 3, leafdecay = 3, flammable = 2, leaves = 1},
	walkable = false,
	drop = {
		max_items = 1,
		items = {
...
minetest.register_node("default:stone_with_iron", {
	...
	groups = {cracky = 2, dinos = 2, stone = 1},
...
minetest.register_node("default:bush_leaves", {
	...
	paramtype = "light",
	groups = {dig_immediate = 3, flammable = 2, leaves = 1},
	drop = {
		max_items = 11,
		items = {
			{items = {"default:bush_sapling"}, rarity = 10},
			{items = {"default:fiber"}, rarity = 2},
			{items = {"farming:tintoberry"}},
			{items = {"farming:amarberry"}},
			{items = {"farming:azulberry"}},
			{items = {"farming:mejoberry"}, rarity = 2},
			{items = {"farming:narcoberry"}, rarity = 3},
			{items = {"farming:stimberry"}, rarity = 2},
			{items = {"farming:verdberry"}},
			{items = {"farming:magenberry"}},
			{items = {"farming:cianberry"}}
		}
	},
	sounds = default.node_sound_leaves_defaults(),
	walkable = false,
...
minetest.register_node("default:blueberry_bush_leaves_with_berries", {
	...
	paramtype = "light",
	groups = {dig_immediate = 3, flammable = 2, leaves = 1, dig_immediate = 3},
...
minetest.register_node("default:seagrass", {
	description = S("Sea Grass"),
	drawtype = "plantlike_rooted",
	waving = 1,
	tiles = {"default_sand.png"},
	special_tiles = {{name = "default_kelp.png"}},
	inventory_image = "default_kelp.png",
	wield_image = "default_kelp.png",
	paramtype = "light",
	groups = {dig_immediate = 3},
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if def_top and def_top.liquidtype == "source" and
			...
			if not minetest.is_protected(pos, player_name) and
					not minetest.is_protected(pos_top, player_name) then
				minetest.set_node(pos, {name = "default:seagrass",
					param2 = height * 16})
				if not minetest.is_creative_enabled(player_name) then
					itemstack:take_item()
				end
...
minetest.register_node("default:frozen_water", {
	description = S("Frozen Water Source"),
	drawtype = "liquid",
	waving = 3,
	tiles = {
		{
	...
	drowning = 1,
	liquidtype = "source",
	liquid_alternative_flowing = "default:frozen_water_flowing",
	liquid_alternative_source = "default:frozen_water",
	liquid_viscosity = 1,
	damage_per_second = 4 * 2,
	post_effect_color = {a = 103, r = 30, g = 60, b = 90},
...
minetest.register_node("default:frozen_water_flowing", {
	description = S("Flowing Frozen Water"),
	drawtype = "flowingliquid",
	waving = 3,
	tiles = {"default_water.png"},
	special_tiles = {
	...
	damage_per_second = 4 * 2,
	post_effect_color = {a = 103, r = 30, g = 60, b = 90},
	groups = {water = 3, liquid = 3, not_in_creative_inventory = 1, igniter = 1},
	sounds = default.node_sound_water_defaults(),
})
