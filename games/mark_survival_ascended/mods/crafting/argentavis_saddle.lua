...
minetest.register_node("crafting:argentavis_saddle", {
	description = S("Argentavis Saddle"),
	drawtype = "normal",
	tiles = {"crafting.table_top.png", "paleotest_argentavis_saddle.png",
		"paleotest_argentavis_saddle.png", "paleotest_argentavis_saddle.png",
		"paleotest_argentavis_saddle.png", "paleotest_argentavis_saddle.png"},
	inventory_image = "paleotest_argentavis_saddle.png",
	wield_image = "paleotest_argentavis_saddle.png",
...
local argentavis_saddle_recipe = {
	output = "crafting:argentavis_saddle",
	recipe = {
			{"group:cuirass","paleotest:hide","group:cuirass"},
			{"default:fiber","crafting:table","default:fiber"},
			{"group:cuirass","paleotest:hide","group:cuirass"},
	},
}

minetest.register_craft(argentavis_saddle_recipe)
