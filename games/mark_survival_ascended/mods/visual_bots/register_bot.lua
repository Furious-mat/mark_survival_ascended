...
minetest.register_craft({
	output = "vbots:off",
	recipe = {
		{"paleotest:black_pearl", "default:steel_ingot", "give_initial_stuff:specimen_implant", "default:steel_ingot", "paleotest:black_pearl"},
		{"paleotest:oil_ore", "vehicles:engine", "default:steel_ingot", "vehicles:engine", "paleotest:oil_ore"},
		{"paleotest:oil_ore", "paleotest:pelt", "vehicles:engine", "paleotest:pelt", "paleotest:oil_ore"},
		{"group:polymer", "vehicles:engine", "default:obsidian", "vehicles:engine", "group:polymer"},
		{"paleotest:oil_ore", "paleotest:pelt", "overpowered:alpha_endboss_lock", "paleotest:pelt", "paleotest:oil_ore"},
		{"paleotest:oil_ore", "quartz:quartz_crystal", "overpowered:alpha_endboss_lock", "quartz:quartz_crystal", "paleotest:oil_ore"},
		{"paleotest:oil_ore", "paleotest:electronics", "paleotest:electronics", "paleotest:electronics", "paleotest:oil_ore"},
		{"group:egg", "group:paleo_sac", "group:dna", "group:paleo_syringe", "group:dossier"},
		{"overpowered:block", "paleotest:black_pearl", "paleotest:electronics", "paleotest:black_pearl", "overpowered:block"},
		{"give_initial_stuff:gamma_ascension_specimen_implant", "overpowered:block", "give_initial_stuff:beta_ascension_specimen_implant", "overpowered:block", "give_initial_stuff:alpha_ascension_specimen_implant"},
	}
})
