...
minetest.register_craft({
	...
	recipe = {
		...
		{"default:thatch", "default:fiber", "default:thatch"}
	}
})
-- ]]
    ...
    on_rightclick = function(pos, node, clicker, itemstack, pointed_thing)
        if clicker:is_player() then
	        ...
	        if nodename:match("thatch") then
                ...
                minetest.chat_send_player(clicker:get_player_name(), S("You need thatch!"))
                return itemstack
	        end
        end
    end,
   ...
   on_rightclick = function(pos, node, clicker, itemstack, pointed_thing)
      if clicker:is_player() then
         ...
         if not inv then
            ...
            local remaining = inv:add_item("main", {name = "bonemeal:fertiliser"})
            if not remaining:is_empty() then
               minetest.add_item(clicker:get_pos(), {name = "bonemeal:fertiliser"})
            end
			else
