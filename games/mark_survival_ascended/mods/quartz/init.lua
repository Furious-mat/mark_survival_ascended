...
minetest.register_node("quartz:quartz_ore", {
	...
	drop = {
		max_items = 5,
		items = {
			{items = {"flowers:mushroom_brown"}, rarity = 4},
			{items = {"quartz:quartz_crystal_piece"}, rarity = 4},
			{items = {"flowers:mushroom_red"}, rarity = 4},
...
minetest.register_craft({
	...
	recipe = {
		{'quartz:quartz_crystal_piece', 'quartz:quartz_crystal_piece', ''},
		{'quartz:quartz_crystal_piece', 'quartz:quartz_crystal_piece', ''},
		{'',             '',             ''},
	}
})
