...
minetest.register_entity("paleotest:ankylosaurus", {
    -- Stats
    max_hp = 700,
    ...
    visual = "mesh",
    mesh = "paleotest_ankylosaurus.b3d",
    female_textures = {"paleotest_ankylosaurus_female.png"},
    male_textures = {"paleotest_ankylosaurus_male.png"},
    child_textures = {"paleotest_ankylosaurus_female.png"},
    sleep_overlay = "paleotest_ankylosaurus_male.png",
    child_sleep_overlay = "paleotest_ankylosaurus_male.png",
    animation = {
    ...
    sounds = {
        ...
        hurt = {
            name = "paleotest_ankylosaurus_hurt",
            gain = 1.0,
            distance = 16
        },
        death = {
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:ankylosaurus_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_ankylosaurus_fg.png",
                male_image = "paleotest_ankylosaurus_fg.png",
                diet = "Herbivore",
                temper = "Docile"
            }))
        end
...
mob_core.register_spawn_egg("paleotest:ankylosaurus", "473f33cc", "393225d9")

minetest.register_craftitem("paleotest:ankylosaurus_dossier", {
	description = "Ankylosaurus Dossier",
	stack_max= 1,
