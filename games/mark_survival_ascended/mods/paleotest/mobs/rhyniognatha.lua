...
minetest.register_entity("paleotest:rhyniognatha", {
    ...
    male_textures = {"paleotest_rhyniognatha.png"}, -- MIT Textures
    ...
    drops = {
        ...
        {name = "paleotest:rhyniognatha_pheromone", chance = 5, min = 1, max = 0}
    },
    timeout = 0,
...
minetest.register_craftitem("paleotest:rhyniognatha_feeder", {
	description = "Rhyniognatha Feeder",
	stack_max= 1,
	inventory_image = "paleotest_rhyniognatha_feeder.png",
})
