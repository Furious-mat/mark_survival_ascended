...
local function iguanodon_logic(self)
    ...
    if mobkit.timer(self, 1) then
		...
		mob_core.random_loot_drop(self, 60, 300, "multiplant:multiplant")
...
minetest.register_entity("paleotest:iguanodon", {
    ...
    visual = "mesh",
    mesh = "paleotest_iguanodon.obj",
    female_textures = {"paleotest_iguanodon.png"},
    male_textures = {"paleotest_iguanodon.png"},
    child_textures = {"paleotest_iguanodon.png"},
    sleep_overlay = "paleotest_iguanodon.png",
    child_sleep_overlay = "paleotest_iguanodon.png",
    animation = {
    ...
    on_rightclick = function(self, clicker)
        ...
        if clicker:get_wielded_item():get_name() == "paleotest:iguanodon_saddle" then
