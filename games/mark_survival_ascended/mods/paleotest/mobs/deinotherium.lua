...
local function deinotherium_logic(self)
...
minetest.register_entity("paleotest:deinotherium", {
    -- Stats
    max_hp = 1026,
    ...
    visual = "mesh",
    mesh = "paleotest_deinotherium.b3d",
    female_textures = {"paleotest_deinotherium.png"},
    male_textures = {"paleotest_deinotherium.png"},
    child_textures = {"paleotest_deinotherium.png"},
    animation = {
    ...
    sounds = {
        ...
        hurt = {
            name = "paleotest_deinotherium1",
            gain = 1.0,
            distance = 16
        },
        death = {
            name = "paleotest_deinotherium2",
            gain = 1.0,
            distance = 16
        }
    },
    ...
    timeout = 0,
    logic = deinotherium_logic,
    get_staticdata = mobkit.statfunc,
    on_activate = paleotest.on_activate,
    on_step = paleotest.on_step,
    on_rightclick = function(self, clicker)
        if paleotest.feed_tame(self, clicker, 65, true, false) then
            return
        end
        if clicker:get_wielded_item():get_name() == "paleotest:field_guide" then
            minetest.show_formspec(clicker:get_player_name(),
                                   "paleotest:paracer_guide",
                                   paleotest.register_fg_entry(self, {
                female_image = "paleotest_deinotherium_fg.png",
                male_image = "paleotest_deinotherium_fg.png",
                diet = "Herbivore",
                temper = "Docile"
            }))
        end
...
mob_core.register_spawn_egg("paleotest:deinotherium", "382f1bcc", "2a230dd9")

minetest.register_craftitem("paleotest:deinotherium_dossier", {
	description = "Deinotherium Dossier",
	stack_max= 1,
	inventory_image = "paleotest_deinotherium_fg.png",
	groups = {dossier = 1},
})
