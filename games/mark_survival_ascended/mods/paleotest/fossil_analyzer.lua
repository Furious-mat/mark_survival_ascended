...
local fossil_output = {
    ...
    "paleotest:dna_velociraptor", "paleotest:dna_allosaurus",
    "paleotest:dna_angler", "paleotest:dna_ankylosaurus",
    "paleotest:dna_archaeopteryx", "paleotest:dna_baryonyx",
    "paleotest:dna_argentavis", "paleotest:dna_arthropluera",
    "paleotest:dna_basilosaurus", "paleotest:dna_beelzebufo",
    "paleotest:dna_carbonemys", "paleotest:dna_carcharodontosaurus",
    "paleotest:dna_compy", "paleotest:dna_dilophosaur",
    "paleotest:dna_dimetrodon", "paleotest:dna_dimorphodon",
    "paleotest:dna_diplodocus", "paleotest:dna_dodo",
    "paleotest:dna_electrophorus", "paleotest:dna_gallimimus",
    "paleotest:dna_giganotosaurus", "paleotest:dna_ichthyornis",
    "paleotest:dna_ichthyosaurus", "paleotest:dna_iguanodon",
    "paleotest:dna_kairuku", "paleotest:dna_kentrosaurus",
    "paleotest:dna_lystrosaurus", "paleotest:dna_megalania",
    "paleotest:dna_megalodon", "paleotest:dna_megalosaurus",
    "paleotest:dna_microraptor", "paleotest:dna_oviraptor",
...
local bone_output = {
    ...
    "paleotest:dna_smilodon", "paleotest:dna_thylacoleo",
    "paleotest:dna_castoroides", "paleotest:dna_daeodon",
    "paleotest:dna_dire_bear", "paleotest:dna_doedicurus",
    "paleotest:dna_equus", "paleotest:dna_gigantopithecus",
    "paleotest:dna_hyaenodon", "paleotest:dna_megaloceros",
    "paleotest:dna_mesopithecus", "paleotest:dna_phiomia",
    "paleotest:dna_purlovia", "paleotest:dna_megaloceros"
}
local waste_bone = {"bones:bones"}

local plant_output = {
    "paleotest:fossilized_cycad_seeds", "paleotest:fossilized_horsetail_spores",
    "paleotest:metasequoia_sapling_petrified", "paleotest:egg_tusoteuthis"
}
