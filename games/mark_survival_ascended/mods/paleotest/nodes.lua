...
minetest.register_node("paleotest:oil_ore", {
    description = "Oil Ore",
    tiles = {"paleotest_oil_ore.png"},
    groups = {cracky = 2},
    drop = {
        max_items = 2,
        items = {
            {items = {'loose_rocks:loose_rocks_1'}, rarity = 2},
            {items = {'paleotest:oil'}}
        }
    },
...
minetest.register_node("paleotest:fossil_block", {
    ...
    drop = {
        ...
        items = {
            ...
            {items = {'bones:bones'}, rarity = 4}, {items = {'loose_rocks:loose_rocks_1'}}
        }
    },
    sounds = default.node_sound_stone_defaults()
})
...
minetest.register_node("paleotest:silica_pearls", {
	description = "Silica Pearls",
	drawtype = "plantlike_rooted",
	waving = 1,
	paramtype = "light",
	tiles = {"default_stone.png"},
	special_tiles = {{name = "paleotest_silica_pearls.png", tileable_vertical = true}},
	inventory_image = "paleotest_silica_pearls.png",
	wield_image = "paleotest_silica_pearls.png",
	groups = {snappy = 3},
	walkable = false,
...
minetest.register_node("paleotest:gravestone", {
	description = "Gravestone",
	tiles = {"paleotest_cursed_gravestone.png"},
	paramtype = "light",
	paramtype2 = "facedir",
	drawtype = "mesh",
	mesh = "paleotest_cursed_gravestone.obj",
	is_ground_content = false,
