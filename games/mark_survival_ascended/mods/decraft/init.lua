...
minetest.register_craft({
		...
		recipe = {
			{"group:oil", "group:oil", "group:oil", "group:oil"},
			{"group:oil", "group:polymer", "group:polymer", "group:oil"},
			{"group:oil", "default:steelblock", "quartz:quartz_crystal", "group:oil"},
			{"group:oil", "default:steel_ingot", "group:paste", "group:oil"},
			{"group:oil", "group:oil", "group:oil", "group:oil"}
		}
})
