...
minetest.register_craft({
	...
	recipe = {
		...
		{"group:paste", "default:steel_ingot", "group:paste"},
...
minetest.register_craft({
	...
	recipe = {
		...
		{"tnt:gunpowder", "group:paste", "tnt:gunpowder"},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{"tnt:tnt_stick", "default:thatch", "tnt:tnt_stick"},
		{"default:steel_ingot", "tnt:tnt", "default:steel_ingot"},
		{"default:steel_ingot", "tnt:tnt", "default:steel_ingot"},
		{"tnt:tnt_stick", "loose_rocks:loose_rocks_1", "tnt:tnt_stick"},
	}
})
